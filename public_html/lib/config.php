...
$dbuser = "tev5";//your ucid since we follow this pattern
$dbpass = "Gamecube#10";//database password generated or chosen per respective steps
$dbdatabase = "tev5";//your ucid since we follow this pattern
?>